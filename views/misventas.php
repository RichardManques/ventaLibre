...
<nav>
    <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            <li><a href=""></i>Editar producto</a></li>
            <li><a href=""></i>Agregar producto</a></li>
            <li><a href="misventas.php"></i>Mis ventas</a></li>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p>
                    <span style="font-size:25px;color:black">vendido</span>
                    </p>
                </div>
            </div>
        </div>
